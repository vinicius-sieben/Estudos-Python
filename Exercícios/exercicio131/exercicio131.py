...
def duplicados(nome_lista):
    contador = 0
    for lista in lista_de_listas_de_inteiros:
        print(len(lista)) # Printa a lista atual da iteração.
        for numero in lista:
            print(lista[contador]) # Printa os números existentes dentro da atual lista da iteração.
            if not contador > 10: contador += 1
